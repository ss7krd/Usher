...
our_system = [2.1,11,18,22,32]
ax.plot(stepX[:-1],np.array(our_system)-0.1,c=color_list[0],marker="x", mew=4, markersize=26,ls='-',label="Usher",fillstyle='none', linewidth = 4)
...
# ["2000$", "4000$", "6000$", "8000$", "10000$"]
shepherd = [0.6,1.3,4.8,10,16.8]
# ax.plot(stepX, np.array(static)-5, c = 'blue', marker = 'o', markersize = 26, ls = '-', label = "Scrooge", fillstyle = 'full', linewidth = 4)
ax.plot(stepX[:-1], np.array(shepherd)-0.1, c =color_list[1], marker = 's', mew=5, markersize = 26, ls = '-', label = "Shepherd", fillstyle = 'none', linewidth = 4)

# ["2000$", "4000$", "6000$", "8000$", "10000$"]
# gpulet = [3,6.9,10.4,18.9,22.8,30.2]
gpulet = [1,1.6,6.1,12,17.2]
# ax.plot(stepX, np.array(static)-5, c = 'blue', marker = 'o', markersize = 26, ls = '-', label = "Scrooge", fillstyle = 'full', linewidth = 4)
ax.plot(stepX[:-1], np.array(gpulet)-0.1, c = color_list[2], marker = 'o', mew=4, markersize = 26, ls = '-', label = "GPUlet", fillstyle = 'none', linewidth = 4)

# ["2000$", "4000$", "6000$", "8000$", "10000$"]
# alpaserve = [4.3,8,16.3,25.3,32.8,39]
alpaserve = [1.3,2,6.9,12.5,18.9]
# ax.plot(stepX, np.array(static)-5, c = 'blue', marker = 'o', markersize = 26, ls = '-', label = "Scrooge", fillstyle = 'full', linewidth = 4)
ax.plot(stepX[:-1], np.array(alpaserve)-0.1, c = color_list[3], marker = 'D', mew=3, markersize = 26, ls = '-', label = "AlpaServe", fillstyle = 'none', linewidth = 4)
