...
proposed_igpr = (np.array([96,95,96,45,97,94,41,38,95,42,97,94]))
...
ax.bar(ind,dummy,width,color=[(1,0.7,0)],edgecolor='black',label="Computation utilization")
...
static_igpr = (np.array([70,68,65,97,72,69,52,50,69,50,68,70]))
...
ax.set_position([box.x0 + box.width*0.1, box.y0 + box.height*0.15, box.width, box.height*0.70])
#bbox_to_anchor=(0.5, 1.6)
leg = plt.legend(loc='upper center', bbox_to_anchor=(0.5, 1.5), handler_map={matplotlib.lines.Line2D: SymHandler()}, 
            fontsize='48', ncol=1, handleheight=1, labelspacing=0.5, frameon=False) 
