...
our_system_sm = [99.4,98.8,98.6,98.7,99.1]
our_system_mem = [98.7,99.6,98.9,98.9,99.8]
...
# shepherd_sm = [73.5,73.2,74.6,75.3,75.5]
# shepherd_mem = [59.9,60.3,58.4,58.3,58.2]
shepherd_sm = [73.2,74.6,75.3,75.5]
shepherd_mem = [60.3,58.4,58.3,58.2]
# ax.plot(stepX, np.array(static)-5, c = 'blue', marker = 'o', markersize = 26, ls = '-', label = "Scrooge", fillstyle = 'full', linewidth = 4)
ax[1].plot(stepX[:-1], np.array(shepherd_sm), c =color_list[1], marker = 's', mew=5, markersize = 26, ls = '-', label = "Shepherd", fillstyle = 'none', linewidth = 4)
ax[0].plot(stepX[:-1], np.array(shepherd_mem), c =color_list[1], marker = 's', mew=5, markersize = 26, ls = '-', label = "Shepherd", fillstyle = 'none', linewidth = 4)
# ax.set_ylim(75, 101)
# ytickvalues = []
...
# gpulet_sm = [79.3,78.2,77.4,78.2,79.4]
# gpulet_mem = [68.4,68.5,68.5,68.7,70.4]
gpulet_sm = [78.2,77.4,78.2,79.4]
gpulet_mem = [68.5,68.5,68.7,70.4]
ax[1].plot(stepX[:-1], np.array(gpulet_sm), c = color_list[2], marker = 'o', mew=4, markersize = 26, ls = '-', label = "GPUlet", fillstyle = 'none', linewidth = 4)
ax[0].plot(stepX[:-1], np.array(gpulet_mem), c = color_list[2], marker = 'o', mew=4, markersize = 26, ls = '-', label = "GPUlet", fillstyle = 'none', linewidth = 4)

# alpaserve_sm = [81.3,82.2,81.1,82.4,80.2]
# alpaserve_mem = [76.3,74.2,74,74.4,75.2]
alpaserve_sm = [82.2,81.1,82.4,80.2]
alpaserve_mem = [74.2,74,74.4,75.2]
...
# ax.plot(stepX, np.array(static)-5, c = 'blue', marker = 'o', markersize = 26, ls = '-', label = "Scrooge", fillstyle = 'full', linewidth = 4)
ax[1].plot(stepX[:-1], np.array(alpaserve_sm)+5, c = color_list[3], marker = 'D', mew=3, markersize = 26, ls = '-', label = "AlpaServe", fillstyle = 'none', linewidth = 4)
ax[0].plot(stepX[:-1], np.array(alpaserve_mem), c = color_list[3], marker = 'D', mew=3, markersize = 26, ls = '-', label = "AlpaServe", fillstyle = 'none', linewidth = 4)
...
ax[1].set_xticklabels(["2k", "4k", "8k", "16k", "32k"])
