...
ax.bar(ind,alpaserve_computation,width,color=color_list[0],hatch='+',edgecolor=color_list[0],fill=False,linewidth=2)
...
alpaserve_memory = (np.array([69,97,65,55,72,68,66,65,72,52,52,75]))+5
...
ax.bar(ind+1*width, alpaserve_memory, width, color = color_list[1], hatch='/',edgecolor = color_list[1],fill=False,linewidth=2)
