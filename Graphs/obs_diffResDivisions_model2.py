...
comm_time_3 = np.array([56, 63, 68, 70])
comm_time_2 = np.array([60, 64, 69, 74])
comm_time_1 = np.array([63, 69, 72, 78])
comm_time_0 = np.array([67, 75, 80, 82])
...
ax[3].set_xlabel('GPU computation space allocated to BERT-2.7B')
