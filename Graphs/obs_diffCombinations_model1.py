...
comm_time_3 = np.array([320, 195, 100, 82])
comm_time_2 = np.array([320, 250, 155, 140])
comm_time_1 = np.array([400, 260, 170, 180])
comm_time_0 = np.array([395, 262, 173, 181])
...
ax[3].set_title('No concurrent models',fontsize=38)
ax[2].set_title('MobileNetv2+ResNet18+Shufflenetv2',fontsize = 38)
ax[1].set_title('MobileNetv2+Inception-Resnet+ResNet50',fontsize = 38)
ax[0].set_title('MobileNetv2+Inception-Resnet+SqueezeNet',fontsize = 38)

ax[3].set_ylim(75, 405)
ax[2].set_ylim(75, 405)
ax[1].set_ylim(75, 405)
ax[0].set_ylim(75, 405)
# ytickvalues = []
