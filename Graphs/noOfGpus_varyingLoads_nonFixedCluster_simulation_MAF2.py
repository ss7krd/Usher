...
# our_system = [2400, 2800, 2900, 3600, 3700, 4500]
our_system = [1060, 2060, 3300, 4600, 5700, 6900]
ax.plot(stepX,np.array(our_system)+10,c=color_list[0],marker="x", mew=4, markersize=26,ls='-',label="Usher",fillstyle='none', linewidth = 4)
...
# 8, 16, 32, 64, 128, 256
# shepherd = [5200, 8100, 10400, 13000, 15800, 18000]
shepherd = [2200, 3500, 5000, 7000, 10000, 13000]
# ax.plot(stepX, np.array(static)-5, c = 'blue', marker = 'o', markersize = 26, ls = '-', label = "Scrooge", fillstyle = 'full', linewidth = 4)
ax.plot(stepX, np.array(shepherd)+10, c =color_list[1], marker = 's', mew=5, markersize = 26, ls = '-', label = "Shepherd", fillstyle = 'none', linewidth = 4)

gpulet = [1900, 3400, 4850, 7000, 8700, 11000]
# ax.plot(stepX, np.array(static)-5, c = 'blue', marker = 'o', markersize = 26, ls = '-', label = "Scrooge", fillstyle = 'full', linewidth = 4)
ax.plot(stepX, np.array(gpulet)+10, c = color_list[2], marker = 'o', mew=4, markersize = 26, ls = '-', label = "GPUlet", fillstyle = 'none', linewidth = 4)
# ax.set_ylim(75, 101)
# ytickvalues = []
...
alpaserve = [1800, 3207, 4600, 6700, 8100, 10900]
# ax.plot(stepX, np.array(static)-5, c = 'blue', marker = 'o', markersize = 26, ls = '-', label = "Scrooge", fillstyle = 'full', linewidth = 4)
ax.plot(stepX, np.array(alpaserve)+10, c = color_list[3], marker = 'D', mew=3, markersize = 26, ls = '-', label = "AlpaServe", fillstyle = 'none', linewidth = 4)
