...
# 8, 16, 32, 64, 128, 256
# shepherd_sm = [75.2,75.3,73.6,73.7,75.1]
# shepherd_mem = [60.1,60,59.8,59.8,62.15]
shepherd_sm = [75.3,73.6,73.7,75.1]
shepherd_mem = [60,59.8,59.8,62.15]
...
# gpulet_mem = [68.8,70.2,72.5,70.2,70.1]
gpulet_sm = [77.8,79.2,79.4,79.5]
gpulet_mem = [70.2,72.5,70.2,70.1]
...
# alpaserve_sm = [81.2,80.3,80.3,82.4,82.4]
# alpaserve_mem = [75,74.2,75.8,74.1,74.1]
alpaserve_sm = [80.3,80.3,82.4,82.4]
alpaserve_mem = [74.2,75.8,74.1,74.1]
