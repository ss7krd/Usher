...
our_system_sm = [98.6,99,99.1,98.7,99]
our_system_mem = [99.2,99.4,99.1,99.6,99]
...
# 8, 16, 32, 64, 128, 256
# shepherd_sm = [75.2,73.6,73.6,73.7,75.1]
# shepherd_mem = [60.1,62.15,59.8,59.8,62.15]
shepherd_sm = [73.6,73.6,73.7,75.1]
shepherd_mem = [62.15,59.8,59.8,62.15]
...
# gpulet_sm = [78.1,77.8,79.2,79.4,79.5]
# gpulet_mem = [68.8,72.5,72.5,70.2,70.1]
gpulet_sm = [77.8,79.2,79.4,79.5]
gpulet_mem = [72.5,72.5,70.2,70.1]
...
# alpaserve_sm = [81.2,80.3,82.3,82.4,82.4]
# alpaserve_mem = [75,74.2,74.2,74.1,76.1]
alpaserve_sm = [80.3,82.3,82.4,82.4]
alpaserve_mem = [74.2,74.2,74.1,76.1]
