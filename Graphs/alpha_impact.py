...
dummy_1 = [95.5,96.2,99.98,97.4,96] #acc.
dummy = [0,0,0,0,0]
...
ax.bar(ind,dummy,width,color=color_list[1],edgecolor=color_list[1],hatch='',fill=True,label="Time for\nresource\nestimation",linewidth=2)
...
ax2.bar(ind+1*width, dummy_2, width, color = color_list[1], hatch='',edgecolor = color_list[1],fill=True,linewidth=2)
...
ax.set_position([box.x0 + box.width*0.05, box.y0 + box.height*0.3, box.width*0.9, box.height*0.5])
#bbox_to_anchor=(0.5, 1.6)
leg = ax.legend(loc='upper center', bbox_to_anchor=(0.5, 1.9), handler_map={matplotlib.lines.Line2D: SymHandler()}, 
