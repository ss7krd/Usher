...
# our_system = [0.5, 1, 2, 2, 4]
our_system = [1.5, 2, 2, 4, 7.5]
ax.plot(stepX,np.array(our_system)*multiplier,c=color_list[0],marker="x", mew=4, markersize=26,ls='-',label="Usher",fillstyle='none', linewidth = 4)
...
ax.plot(stepX[:-1], np.array(shepherd)*multiplier, c =color_list[1], marker = 's', mew=5, markersize = 26, ls = '-', label = "Shepherd", fillstyle = 'none', linewidth = 4)

# gpulet = [3, 5, 7, 8, 11]
gpulet = [5, 7, 8, 11]
ax.plot(stepX[:-1], np.array(gpulet)*multiplier, c = color_list[2], marker = 'o', mew=4, markersize = 26, ls = '-', label = "GPUlet", fillstyle = 'none', linewidth = 4)
# ax.set_ylim(75, 101)
# ytickvalues = []
...
# alpaServe = [3, 6, 6, 8, 12]
# alpaserve = [2, 5, 5, 7, 10]
alpaserve = [5, 5, 7, 10]
# ax.plot(stepX, np.array(static)-5, c = 'blue', marker = 'o', markersize = 26, ls = '-', label = "Scrooge", fillstyle = 'full', linewidth = 4)
ax.plot(stepX[:-1], np.array(alpaserve)*multiplier, c = color_list[3], marker = 'D', mew=3, markersize = 26, ls = '-', label = "AlpaServe", fillstyle = 'none', linewidth = 4)
