...
while True:
	...
	proposed.append(random.triangular(700,800))
...
for i in range(200, 250):
	proposed[i] = random.triangular(500,750)
for i in range(250, 290):
	proposed[i] = random.triangular(300,400)
for i in range(290, len(proposed)):
	proposed[i] = random.triangular(350,480)
