...
our_system = [1060, 2060, 3300, 4600, 5700, 6500]
ax.plot(stepX,np.array(our_system),c=color_list[0],marker="x", mew=4, markersize=26,ls='-',label="Usher",fillstyle='none', linewidth = 4)
...
shepherd = [2200, 3500, 5000, 7000, 9000, 13000]
...
gpulet = [1900, 3400, 4850, 7000, 8000, 11000]
# ax.plot(stepX, np.array(static)-5, c = 'blue', marker = 'o', markersize = 26, ls = '-', label = "Scrooge", fillstyle = 'full', linewidth = 4)
...
alpaserve = [1800, 3207, 4600, 6700, 7800, 10900]
# ax.plot(stepX, np.array(static)-5, c = 'blue', marker = 'o', markersize = 26, ls = '-', label = "Scrooge", fillstyle = 'full', linewidth = 4)
