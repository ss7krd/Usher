...
our_system = [8,16,32,43,43,43]
ax.plot(stepX,np.array(our_system),c='red',marker="x", mew=4, markersize=26,ls='-',label="Usher",fillstyle='none', linewidth = 4)
...
# 8, 16, 32, 64, 128, 256
shepherd = [8,16,17.6,17.6,17.6,17.6]
# ax.plot(stepX, np.array(static)-5, c = 'blue', marker = 'o', markersize = 26, ls = '-', label = "Scrooge", fillstyle = 'full', linewidth = 4)
ax.plot(stepX, np.array(shepherd), c = 'black', marker = 's', markersize = 26, ls = '-', label = "Shepherd", fillstyle = 'none', linewidth = 4)

gpulet = [8,16,18.4,18.4,18.4,18.4]
# ax.plot(stepX, np.array(static)-5, c = 'blue', marker = 'o', markersize = 26, ls = '-', label = "Scrooge", fillstyle = 'full', linewidth = 4)
ax.plot(stepX, np.array(gpulet), c = 'green', marker = '*', mew=4, markersize = 26, ls = '-', label = "GPUlet", fillstyle = 'none', linewidth = 4)

alpaserve = [8,16,21.3,21.3,21.3,21.3]
# ax.plot(stepX, np.array(static)-5, c = 'blue', marker = 'o', markersize = 26, ls = '-', label = "Scrooge", fillstyle = 'full', linewidth = 4)
ax.plot(stepX, np.array(alpaserve), c = 'blue', marker = 'D', markersize = 26, ls = '-', label = "AlpaServe", fillstyle = 'none', linewidth = 4)
...
leg = plt.legend(loc='upper center', bbox_to_anchor=(0.44, 1.35), handler_map={matplotlib.lines.Line2D: SymHandler()}, 
