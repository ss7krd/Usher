...
our_system = [1500,1550,1900,1900,2250,2400]
our_system = np.array(our_system)*2
ax.plot(stepX,np.array(our_system)-200,c=color_list[0],marker="x", mew=4, markersize=26,ls='-',label="Usher",fillstyle='none', linewidth = 4)
...
# 8, 16, 32, 64, 128, 256
shepherd = [2800,3100,3500,4000,4200,4350]
...
ax.plot(stepX, np.array(shepherd), c =color_list[1], marker = 's', mew=5, markersize = 26, ls = '-', label = "Shepherd", fillstyle = 'none', linewidth = 4)

gpulet = [2600,2900,3350,3690,4095,4295]
gpulet = np.array(gpulet)*2
# ax.plot(stepX, np.array(static)-5, c = 'blue', marker = 'o', markersize = 26, ls = '-', label = "Scrooge", fillstyle = 'full', linewidth = 4)
ax.plot(stepX, np.array(gpulet), c = color_list[2], marker = 'o', mew=4, markersize = 26, ls = '-', label = "GPUlet", fillstyle = 'none', linewidth = 4)
...
alpaserve = [2500,2700,3200,3500,4000,4200]
alpaserve = np.array(alpaserve)*2
# ax.plot(stepX, np.array(static)-5, c = 'blue', marker = 'o', markersize = 26, ls = '-', label = "Scrooge", fillstyle = 'full', linewidth = 4)
ax.plot(stepX, np.array(alpaserve), c = color_list[3], marker = 'D', mew=3, markersize = 26, ls = '-', label = "AlpaServe", fillstyle = 'none', linewidth = 4)
