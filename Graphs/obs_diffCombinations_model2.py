...
comm_time_3 = np.array([1200, 800, 680, 580])
comm_time_2 = np.array([1300, 905, 770, 700])
comm_time_1 = np.array([1305, 910, 775, 705])
comm_time_0 = np.array([1290, 908, 765, 695])
...
ax[2].set_title('BERT+ResNet50+YOLOv3',fontsize = 38)
ax[1].set_title('BERT+Inception-Resnet+ResNet18',fontsize = 38)
ax[0].set_title('BERT+MobileNetv3+SqueezeNet',fontsize = 38)

ax[3].set_ylim(575, 1315)
ax[2].set_ylim(575, 1315)
ax[1].set_ylim(575, 1315)
ax[0].set_ylim(575, 1315)
# ytickvalues = []
