...
shepherd_computation = (np.array([96,38,81,45,97,81,41,95,94,42,97]))+5#not holistic
shepherd_computation = (np.array([95,74,96,78,82,80,78,80,75,78]))-5
...
# ax.bar(ind,dummy,width,color='darkgrey',edgecolor='black',label="Memory utilization")
...
# 96,95,81,45,97,94,41,38,81,42,97
# 96,38,81,45,97,81,41,95,94,42,97
shepherd_memory = (np.array([55,65,65,97,72,53,67,52,69,65,51]))+5#not holistic
shepherd_memory = (np.array([85,79,90,75,77,85,80,83,78,83]))-5
...
xvalues = ["G1","G2","G3","G4","G5","G6","G7","G8","G9","G10"]
