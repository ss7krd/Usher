...
stepX = [0.3, 0.35, 0.4, 0.45, 0.5, 0.55, 0.6, 0.65]
...
stepX = [0.3, 0.35, 0.4, 0.45, 0.5, 0.55, 0.6, 0.65]
alpaserve = [11, 26, 34, 41, 80, 100, 100, 100]
gpulet = [0, 5, 21, 41, 50, 87, 100, 100]
ax.plot(stepX, np.array(gpulet)/100, c = 'red', ls = '-', fillstyle = 'full', linewidth = 4, label='GPUlet')
ax.plot(stepX, np.array(alpaserve)/100, c = 'blue', ls = '-.', fillstyle = 'full', linewidth = 4, label='AlpaServe')




ax.set_xlabel('Ratio between goodputs w/ and w/o\nmultiplexing for a model')
ax.set_ylabel('CDF')
# ax.set_ylim(0,4500)
...
ax.set_position([box.x0 + box.width*0.01, box.y0 + box.height*0.35, box.width, box.height*0.65])
