...
gpulet_computation = (np.array([95,96,55,93,96,60,90,60,95,92,88,65]))
...
ax.bar(ind,gpulet_computation,width,color=color_list[0],hatch='+',edgecolor=color_list[0],fill=False,linewidth=2)
...
gpulet_memory = (np.array([72,66,65,55,72,68,97,52,69,52,65,75]))
...
ax.bar(ind+1*width, gpulet_memory, width, color = color_list[1], hatch='/',edgecolor = color_list[1],fill=False,linewidth=2)
